...
Case 04 now uses [`evidence/04-m-systems-2001-2003-interrupted-erase-recovery-deepening.md`](evidence/04-m-systems-2001-2003-interrupted-erase-recovery-deepening.md) only for the retention-specific seam between **interruptible destructive erase**, **retained pending/completion evidence**, **conservative restart replay**, and **re-established physical-space reuse authority**. A fresh companion search found no dedicated TrueFFS / `US6977847` packet to reuse. Broad TrueFFS/DiskOnChip chronology, Flash erase-circuit history, Partial Page Programming evolution, M-Systems patent-family genealogy, and shipped-controller archaeology remain `computing-archaeology` work rather than being duplicated here.
