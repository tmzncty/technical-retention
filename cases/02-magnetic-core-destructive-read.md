...
MTC / IRE medium-versus-system power-removal deepening: [`../evidence/02-mtc-1956-1957-nonvolatile-system-power-removal-boundary-deepening.md`](../evidence/02-mtc-1956-1957-nonvolatile-system-power-removal-boundary-deepening.md). The 1956 IRE vocabulary explicitly separates nonvolatile media from device/system behavior under power removal, while the 1957 MTC manual adds ordered power transitions, a temperature-bounded operating regime, pre-shutdown core-memory copying plus PC/register capture, and explicit panel-memory entry into core-resident programs. This advances the 1950s restart-boundary evidence without claiming ordinary MTC power-off erased core or that MTC terminology caused later IBM/DEC designs.
