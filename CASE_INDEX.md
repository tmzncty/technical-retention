...
**Current adversarial bridge:** [`cases/06-flip-flop-powered-working-retention.md`](cases/06-flip-flop-powered-working-retention.md) is still `first-pass`, now with [`evidence/06-flip-flop-register-boundary-addendum.md`](evidence/06-flip-flop-register-boundary-addendum.md), [`evidence/06-eniac-timing-retention-deepening.md`](evidence/06-eniac-timing-retention-deepening.md), and [`evidence/06-eccles-jordan-1919-proceedings-deepening.md`](evidence/06-eccles-jordan-1919-proceedings-deepening.md). It supports short-lived working retention, separates continuous power from periodic state reconstruction, allows **state-sensitive use** rather than requiring explicit retrieval, has a period architectural `register` witness, directly anchors staged timing retention in ENIAC Part II p. IV-43, and now independently anchors the 1919 regenerative trigger mechanism in a contemporary authorial proceedings record.

**Next highest-value unit:** finish the remaining ENIAC schematic blocker before opening the next semiconductor bridge. Directly render/inspect PX-1-105 `Flip-Flop Circuit` / immediately relevant original drawing context and compare only visible topology against the already recovered Part-II sequence. Exact _Electrician_ p. 298 / _Radio Review_ pp. 143–146 facsimile inspection remains archival cleanup rather than sole mechanism support. Promote Case 06 only if the original schematic material confirms the current mechanism boundaries.
