...
- [ ] latch / flip-flop / register — a bounded `first-pass` bridge exists in [`cases/06-flip-flop-powered-working-retention.md`](cases/06-flip-flop-powered-working-retention.md), with source-deepening ledgers [`evidence/06-flip-flop-register-boundary-addendum.md`](evidence/06-flip-flop-register-boundary-addendum.md), [`evidence/06-eniac-timing-retention-deepening.md`](evidence/06-eniac-timing-retention-deepening.md), and [`evidence/06-eccles-jordan-1919-proceedings-deepening.md`](evidence/06-eccles-jordan-1919-proceedings-deepening.md). Eccles–Jordan GB148582A and the 1946 ENIAC report establish regenerative powered state, explicit set/reset/clear, short-lived working-state use, and ENIAC's own `stores` / `remembers` vocabulary. Whirlwind R-221 closes the period-`register` gap. ENIAC Part II p. IV-43 directly supplies a two-flip-flop timing sequence in which an unsynchronized switch event is retained until central-programming pulses can turn it into a reliable synchronized transmitter action. The British Association's published record of its 1919 Bournemouth meeting now directly supplies a second contemporary authorial mechanism description: `trigger relay`, resistance coupling, back coupling from last valve to first, an electrical stimulus, and `no restoring influence`; the proceedings themselves cite _The Electrician_ p. 298 and _Radio Review_ p. 143. This closes the substantive 1919 authorial mechanism-text gap beyond the patent. Exact _Electrician_ / _Radio Review_ facsimile inspection remains desirable archival cleanup, but the main promotion blocker is now direct rendering/inspection of PX-1-105 / immediately relevant ENIAC original schematic material;
- [ ] SRAM and cache;
...
**Current technical stress test:** [`cases/06-flip-flop-powered-working-retention.md`](cases/06-flip-flop-powered-working-retention.md) remains `first-pass`, now with [`evidence/06-flip-flop-register-boundary-addendum.md`](evidence/06-flip-flop-register-boundary-addendum.md), [`evidence/06-eniac-timing-retention-deepening.md`](evidence/06-eniac-timing-retention-deepening.md), and [`evidence/06-eccles-jordan-1919-proceedings-deepening.md`](evidence/06-eccles-jordan-1919-proceedings-deepening.md). Its primary evidence supports short-duration retention, continuous-power/refresh separation, later state-sensitive use without a discrete retrieval transaction, a period architectural `register` boundary, a Part-II timing-retention sequence in which a pending unsynchronized event survives until machine timing can safely turn it into transmitter action, and now a second contemporary Eccles–Jordan mechanism account beyond the patent.

**Next highest-value unit:** finish the remaining **ENIAC schematic** blocker rather than opening another broad case. Directly render and inspect PX-1-105 `Flip-Flop Circuit` / immediately relevant original drawing context, then compare the observed topology against the already recovered Part-II sequence. Exact _Electrician_ p. 298 / _Radio Review_ pp. 143–146 facsimile inspection remains useful archival cleanup, but the 1919 mechanism is no longer dependent on it because the British Association proceedings directly record the authors' trigger-relay mechanism and point to those periodical versions. Promote Case 06 only if the original schematic material confirms the current mechanism reconstruction.

The first generic thesis-audit sequence, four named philosophical/prior-art tests, and the first category-coherence audit are complete. Do not promote the bounded relational criterion into a grand `What Is Technical Retention?` chapter yet. The flip-flop case has already forced one wording correction — `later state-sensitive use` must be allowed alongside explicit recovery — and the Whirlwind witness adds a second: retention substrate and architectural register role are separate comparison axes. The new Part-II timing sequence adds a third stress: the retained target can be a pending event condition whose value lies in surviving to a later machine-timed operation.
