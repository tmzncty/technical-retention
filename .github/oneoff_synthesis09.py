...
SYNTH = ROOT / "docs/SYNTHESIS_09_DISTRIBUTED_CODED_SERVICE_REPAIR_PLACEMENT.md"
...
SYNTH.write_text(r'''# Synthesis 09 — Distributed Coded Storage: Read Recovery, Durable Repair, Placement Restoration, and Representation Handoff
...
insert_after_prefix_line(
    README,
    "A bounded proactive-integrity comparison is now available in [`docs/SYNTHESIS_08_PROACTIVE_INTEGRITY_REPAIR_MARGIN.md`]",
...
assert "### Cross-case distributed-coded service synthesis — read recovery, durable repair, placement, and handoff" not in index_text
assert "1383. **proactive checking ≠ timeless certainty or one historical lineage**" in index_text
append = r'''
